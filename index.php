	          ...
	          <div class="col-lg-12 text-center mx-auto book-now">
	            <div class="row">
	              ...
	              <div class="col-lg-3 col-xs-12 mx-auto">
	                <a class="btn btn-primary btn-xl js-scroll-trigger book-now-btn" href="/book-now">Book now!</a>
	              </div>
	            </div>
	          </div>
	        </div>
		    ...
		    ?>
		      <div class="row courses-list">
				    ...
				    <div class="col-lg-2 col-xs-12">
		   				<h5 class="text-center">Course Price</h5>
		   				<p class="text-center"><?php echo $courses->price;?></p>
		   			</div>
